...
function Checkout() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-4xl">
        <h1 className="text-4xl font-extrabold text-emerald-400 mb-8 text-center">
        ...
        {orderPlaced ? (
          <>
            ...
            <div className="flex gap-3 mt-6 justify-center">
              <button
                onClick={handlePrint}
                className="bg-emerald-600 text-white px-5 py-2 rounded-lg hover:bg-emerald-700 transition-transform duration-300 hover:scale-105"
              >
                Print Receipt
              </button>
              <button
                onClick={handleDownloadPDF}
                className="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition-transform duration-300 hover:scale-105"
              >
                Download PDF
              </button>
            </div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="bg-white/90 backdrop-blur rounded-2xl shadow-lg p-6"
          >
            {cartItems.map((item) => (
              <div
                key={item._id}
            ...
            <button
              ...
              className="mt-4 w-full bg-emerald-600 text-white py-3 rounded-lg font-semibold hover:bg-emerald-700 transition-transform duration-300 hover:scale-105"
            >
              Place Order
            </button>
          </motion.div>
